...
const projects = [
  {
    ...
    liveLink: '/images/vID1.mp4', // Placeholder
  },
  {
    title: 'Smart Navigation Device For The Visually-Impaired',
    description: "Developed an app for visually impaired users, featuring object identification and caregiver tracking. Trained a model using real-world datasets for accurate object recognition",
    image: '/images/STICK1.jpg',
    imageHint: 'safety technology for the Blind',
    tags: ['Computer Vision', 'Sensors', 'AI', 'Embedded Systems', 'Safety Tech'],
    liveLink: '/images/Vid2.mp4', // Placeholder
  },
  {
